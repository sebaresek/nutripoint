    ...
    html: `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden;">
        ...
        <div style="${headerStyle}">
            <img src="https://pub-33e6f4df8e0a4acb8aea7062a1666a72.r2.dev/nutripoint.png" alt="NutriPoint" style="width: 240px; height: auto; display: block; margin: 0 auto; border: 0;">
        </div>
